    ...
    <main className="min-h-screen flex flex-col items-center relative">
      ...
      <div className="w-full max-w-2xl border-b border-white/10 px-4 py-3 flex items-center gap-3 bg-black/20 backdrop-blur-sm">
        ...
        <div className="flex-1">
          ...
          <p className="text-white/40 text-xs">ETHCC · Cannes 2026</p>
        </div>
        <a
          href="https://github.com/tekr9d3r/tekroxgpt"
          target="_blank"
      ...
      <div className="flex-1 overflow-y-auto w-full max-w-2xl px-4 py-6 flex flex-col">
        ...
        {messages.length === 0 && (
          ...
          >
            ...
            <p className="text-white/50 text-xs uppercase tracking-widest mb-10">ETHCC · Cannes 2026</p>
            <button
